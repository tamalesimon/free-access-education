...
<div className="pt-24 pb-24">
    <div className="container mx-auto">
        <div className="flex flex-row justify-between">
            ...
            <div>
                <div className="border-2 inline-block p-1 rounded cursor-pointer hover:bg-red-100" style={{ borderBlockColor: "#6B6A65"}}>
                ...
                <div className="border-2 ml-2 inline-block rounded cursor-pointer p-1 hover:bg-red-100" style={{ borderBlockColor: "#6B6A65" }}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" className="h-8 text-red-400" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex justify-center">
            <div className="p-5 shadow-md rounded-lg mt-12 inline-block mr-12">
                <div className="p-3 shadow object-center rounded-b-none rounded-lg cursor-pointer" style={{ backgroundImage: "url(https://images.unsplash.com/photo-1509228468518-180dd4864904?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80)", backgroundSize: "cover", height: "325px", width: "20rem" }}></div>
                <div className="relative w-20" style={{ marginLeft: "15px", bottom: "2rem" }}>
                    <img className="rounded-lg border-4 border-white cursor-pointer" src="https://randomuser.me/api/portraits/men/17.jpg" alt=""/>
                </div>
            ...
            <div className="p-5 shadow-md rounded-lg mt-12 inline-block mr-12">
                <div className="p-3 shadow object-center rounded-b-none rounded-lg cursor-pointer" style={{ backgroundImage: "url(https://images.unsplash.com/photo-1576086213369-97a306d36557?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80)", backgroundSize: "cover", height: "325px", width: "20rem" }}></div>
                <div className="relative w-20" style={{ marginLeft: "15px", bottom: "2rem" }}>
                    <img className="rounded-lg border-4 border-white cursor-pointer" src="https://randomuser.me/api/portraits/women/18.jpg" alt=""/>
                </div>
                <div className="w-2/3 font-bold">
            ...
            <div className="p-5 shadow-md rounded-lg mt-12 inline-block mr-12">
                <div className="p-3 shadow object-center rounded-b-none rounded-lg cursor-pointer" style={{ backgroundImage: "url(https://images.unsplash.com/photo-1472173148041-00294f0814a2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80)", backgroundSize: "cover", height: "325px", width: "20rem" }}></div>
                <div className="relative w-20" style={{ marginLeft: "15px", bottom: "2rem" }}>
                    <img className="rounded-lg border-4 border-white cursor-pointer" src="https://randomuser.me/api/portraits/men/20.jpg" alt=""/>
                </div>
                <div className="w-2/3 font-bold">
                ...
                <div className="mt-6 border-t-2 border-gray-200">
                    <div className="mt-5 flex flex-row items-center">
                        <div className="border-red-200 border-2 rounded p-1 mr-5 cursor-pointer">
                            <svg className="h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="#E85A4F">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                            </svg>
                        </div>
                        <div className="flex flex-row items-center">
                            <div className="border-red-200 border-2 rounded p-1 cursor-pointer">
                                <svg className="h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="#E85A4F">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
