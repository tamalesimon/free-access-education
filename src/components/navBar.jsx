...
<div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
    <div class="rounded-lg shadow-md">
        <div class="rounded-lg bg-white shadow-xs overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
            ...
            <div>
                <a href="/" class="block w-full px-5 py-3 text-center font-medium text-red-500 bg-gray-50 hover:bg-gray-100 hover:text-indigo-700 focus:outline-none focus:bg-gray-100 focus:text-indigo-700 transition duration-150 ease-in-out" role="menuitem">
                    Log in
                </a>
            ...
            {/* <div className="flex relative mr-6 md:ml-20 my-2 md:justify-items-center">
                <input 
                type="text" 
                placeholder="Search course here"
                className="bg-purple-white shadow rounded-lg appearance-none outline-none placeholder-gray-400 h-11 border-0 pl-8 p-3 hover:border-red-500"/> 
                <div class="absolute pin-r pin-t mt-3 mr-4 text-red-500">
                    <svg version="1.1" class="h-4 pl-2 mt-1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
