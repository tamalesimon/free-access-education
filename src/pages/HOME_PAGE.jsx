...
<div class="relative overflow-hidden lg:overflow-visible">
      ...
      <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
        <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
          ...
          <div class="hidden md:block md:ml-10 md:pr-4 items-center md:w-full" style={{display:"inherit"}}>
            <a href="/" class="font-normal text-gray-500 hover:text-red-500 transition duration-150 ease-in-out">Product</a>
            <a href="/" class="ml-8 font-normal text-gray-500 hover:text-red-500 transition duration-150 ease-in-out">Features</a>
            <a href="/" class="ml-8 font-normal text-gray-500 hover:text-red-500 transition duration-150 ease-in-out">Marketplace</a>
            <a href="/" class="ml-8 font-normal text-gray-500 hover:text-red-500 transition duration-150 ease-in-out">Company</a>
            ...
            <div className="flex lg:ml-32 md:ml-10">
               <input 
                ...
                className="bg-purple-white shadow-lg rounded-lg appearance-none outline-none placeholder-gray-400 h-11 border-0 pl-8 py-2 hover:border-red-500"/> 
                <div class="absolute pin-r pin-t mt-2 mr-4 text-red-500">
                    <svg version="1.1" class="h-4 pl-2 mt-1"  fill="#F56565" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
      ...
      <main class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="sm:text-center lg:text-left">
          <h2 class="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
            Revise and study
            <br/>
            <span class="text-red-500">from anywhere <br/>for free.</span>
          </h2>
          ...
          <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            <div class="rounded-md shadow">
              <a href="/" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-red-500 hover:bg-red-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                Get started
              </a>
            </div>
            <div class="mt-3 sm:mt-0 sm:ml-3">
              <a href="/" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-red-500 bg-indigo-100 hover:text-indigo-600 hover:bg-indigo-50 focus:outline-none focus:shadow-outline-indigo focus:border-indigo-300 transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                Live demo
              </a>
            </div>            
          </div>
          <div className="flex flex-row align-middle items-center lg:mt-10 lg:ml-10">
               <input 
                type="text" 
                placeholder="What are you studying?"
                className="bg-purple-white shadow-md rounded-lg appearance-none w-2/3 h-20 outline-none placeholder-gray-400 h-11 border-2 border-gray-900 pl-12 py-4 hover:border-red-500"/> 
                <div class="absolute bottom-auto top-auto mr-4 ml-3 text-red-500 flex flex-row items-center align-middle">
                    <svg version="1.1" class="h-5 pl-2 font-bold"  fill="#F56565" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                        viewBox="0 0 52.966 52.966">
                        <path d="M51.704,51.273L36.845,35.82c3.79-3.801,6.138-9.041,6.138-14.82c0-11.58-9.42-21-21-21s-21,9.42-21,21s9.42,21,21,21
                        c5.083,0,9.748-1.817,13.384-4.832l14.895,15.491c0.196,0.205,0.458,0.307,0.721,0.307c0.25,0,0.499-0.093,0.693-0.279
                        C52.074,52.304,52.086,51.671,51.704,51.273z M21.983,40c-10.477,0-19-8.523-19-19s8.523-19,19-19s19,8.523,19,19
                    ...
                    <div className="left-0 relative" style={{left:"370%"}}>
  ...
  <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 md:items-center md:object-center" style={{height:"1024px"}}>
    <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src={`https://images.unsplash.com/photo-1532708059644-5590ed51ce4c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80`} alt=""/>
  </div>
</div>
